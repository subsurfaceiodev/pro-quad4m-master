...
p.add_argument("uacc", action="store", type=is_valid_file,
               help="single-column horizontal acceleration time-history along the x-axis (e.g. the E component)")
p.add_argument("vacc", action="store", type=is_valid_file,
               help="single-column horizontal acceleration time-history along the y-axis (e.g. the N component)")
